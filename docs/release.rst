...
Releasing a new version of `niteoweb.aweber` involves the following steps:
...
In the following example we are releasing version 0.1 of `niteoweb.aweber`. The
...
.. sourcecode:: bash
  ...
  $ bin/mkrelease -d pypi -pq ./
  Releasing niteoweb.aweber 0.1
  Tagging niteoweb.aweber 0.1
  To git@github.com:niteoweb/niteoweb.aweber.git
  * [new tag]         0.1 -> 0.1
  running egg_info
  running sdist
