...
.. sourcecode:: bash
    ...
    $ bin/pyflakes src/niteoweb/aweber
    $ bin/pep8 --ignore=E501 src/niteoweb/aweber
...
the results are visible at http://readthedocs.org/docs/niteowebaweber.
