# -*- coding: utf-8 -*-
# niteoweb.aweber documentation build configuration file, created by
...
htmlhelp_basename = 'niteowebaweberdoc'
...
latex_documents = [
    (
        'index',
        'niteowebaweber.tex',
        u'niteoweb.aweber Documentation',
        u'',
        'manual'
    ),
]
